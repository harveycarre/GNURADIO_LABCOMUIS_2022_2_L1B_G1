...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 12.5E6/8
        self.Kp = Kp = 1
        self.GTX = GTX = 1
        self.Fm = Fm = 1000
        self.Fc = Fc = 50000000
        ...
        self._Fm_range = Range(1000, 200000, 100, 1000, 200)
        self._Fm_win = RangeWidget(self._Fm_range, self.set_Fm, "Frecuencia de l mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Amplitu de la portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_compleja_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.Envolvente_compleja_0.set_Kp(self.Kp)
