...
class ModulacionAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Fc_win = RangeWidget(self._Fc_range, self.set_Fc, "Frecuencia de corte de la portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.SSB_0, 0), (self.qtgui_time_sink_x_1, 0))
