...
class Lab_punto5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "lab_comu_")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab_comu_")
        ...
        self.audio_rate = audio_rate = 20000
        self.BW = BW = 1500
        ...
        self._BW_range = Range(100, 50000, 10, 1500, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\Asus\\OneDrive\\Escritorio\\Comunicaciones\\Audio_de_prueba.wav', True)
