...
class MODULADORPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Modulador pwm", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulador pwm")
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel de la diente de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._A_range = Range(-10, 30, 0.1, 2, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "amplitu de la diente de iserra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._AC_range = Range(-2, 2, 0.1, 1, 200)
        self._AC_win = RangeWidget(self._AC_range, self.set_AC, "Amplitud de las constante", "counter_slider", float, QtCore.Qt.Horizontal)
