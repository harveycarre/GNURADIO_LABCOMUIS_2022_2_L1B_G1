...
class sumador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sumador")
        ...
        # Blocks
        ##################################################
        self._A_range = Range(0, 12, 1, 1, 200)
...
def main(top_block_cls=sumador, options=None):
