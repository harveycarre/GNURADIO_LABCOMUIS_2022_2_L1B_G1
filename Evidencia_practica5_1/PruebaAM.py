...
class PruebaAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaAM")
        ...
        self._AM_win = RangeWidget(self._AM_range, self.set_AM, "Amplitus mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.modulacion_PAM = modulaciondepulsos(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.modulacion_PAM, 0))
        ...
        self.connect((self.modulacion_PAM, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.modulacion_PAM, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.modulacion_PAM, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.modulacion_PAM.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.modulacion_PAM.set_fs(self.fs)
    ...
    def set_D(self, D):
        self.D = D
        self.modulacion_PAM.set_d(self.D)
...
def main(top_block_cls=PruebaAM, options=None):
